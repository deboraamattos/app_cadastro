...
public class DozerConverterTest {
	...
	//MOCK = criar um objeto com a informção que vai ser testado
	...
	private Pessoa mockEntity(Long numero) {
		...
		pessoa.setNomeSocial("Nome Social Teste" + numero);
	...
	public void parseEntityToVOTest() {
		...
		Assert.assertEquals("Nome Social Teste0",output.getNomeSocial());
	...
	public void parseEntityListToVOListTest() {
		...
		Assert.assertEquals("Nome Social Teste0",outputZero.getNomeSocial());
